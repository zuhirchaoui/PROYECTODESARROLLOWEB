        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="orders.php"> &nbsp; <span class='glyphicon glyphicon-list-alt'></span> Mis Pedidos</a></li>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Mis Pedidos</li>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="glyphicon glyphicon-list-alt"></span> Mis Pedidos</h3></center>
        </div>
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  //Conexión con la bd
include("config.php");
 //Slecto de la tabla orderdetails
