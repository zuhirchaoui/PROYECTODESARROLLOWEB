...
<?php
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{		//Actualiza la bd
			$stmt = $DB_con->prepare('UPDATE items SET item_name=:item_name,item_description=:item_description,item_price=:item_price,item_image=:item_image WHERE item_id=:item_id');
...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="items.php">Gestión de Productos</a></li>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="item_description" value="<?php echo $item_description; ?>" required /></td>
    </tr>
