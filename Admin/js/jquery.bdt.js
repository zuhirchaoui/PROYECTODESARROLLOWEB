...
(function ($) {
    ...
    $.fn.bdt = function (options, callback) {
        ...
        return this.each(function () {
            ...
            /**
             * selecciona campo para cambiar fila por página
             */
            obj.after(
                $('<div/>')
                    ...
                    th.click(function () {
                        if(!$(this).hasClass('disable-sorting')) {
                            ...
                            table.find('td').filter(function () {
                                ...
                                // parentNode es el elemento que queremos mover
        ...
        /**
         * crea elementos li para la pagina 
         */
        function addPages() {
            $('#table-nav').remove();
            pages = $('<ul/>');
            ...
            /**
             * paginación, con páginas y enlace anterior y siguiente
             */
            $('#table-footer')
                .addClass('row')
                .append(
